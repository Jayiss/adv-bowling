...
import training.adv.bowling.impl.fanxu.BowlingGameFactory;
...
public class BowlingGameTest {
	...
	public void testExtraTwoPinsWithStrike() {
		...
		for (BowlingTurn bowlingTurn:game.getTurns()){
			System.out.println("f"+bowlingTurn.getFirstPin()+"s:"+bowlingTurn.getSecondPin()+"score:"+bowlingTurn.getScore());
		}
		assertEquals(270, game.getTotalScore());
//
//		game.addScores(10, 5);
